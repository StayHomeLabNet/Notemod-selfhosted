...
// この config/<USER_NAME>/config.api.php は setup_auth.php によって自動生成されます
...
return [
    ...
    // マルチユーザー版では notemod-data/<USER_NAME>/data.json を参照します
    ...
    // true  : 実行前に data.json をバックアップしてから cleanup
    // false : バックアップを作成しない
    'CLEANUP_BACKUP_ENABLED' => true,

    // バックアップファイル名のサフィックス
    // 例: data.json.bak-YYYYMMDD-HHMMSS
    // ※ 互換性のため通常は変更しないでください
